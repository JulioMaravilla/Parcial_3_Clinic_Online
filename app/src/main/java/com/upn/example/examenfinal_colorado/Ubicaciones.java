...
public class Ubicaciones extends AppCompatActivity {
    Button lamolina, sanisidro, lamolina2;
    @Override
    ...
    private void  asignarubicaciones(){
        ...
        lamolina2 = findViewById(R.id.btnlamolina2);
        lamolina2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Ubicaciones.this, Mapas.class);
                intent.putExtra("latitud", "13.991960500707812");
                intent.putExtra("longitud", "-89.5512373032729");
                intent.putExtra("titulo", "Hospital San Juan de Dios");
                startActivity(intent);
            }
        });
    }
